          ...
          <>
            ...
            <div className="border-t border-gray-200 p-4 space-y-4">
              ...
              <div className="flex justify-around pt-4 border-t border-gray-200">
                <button
                  onClick={handleShare}
                  className="flex flex-col items-center gap-2 text-gray-700 hover:text-gray-900 text-xs font-medium"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 text-gray-700 hover:text-red-600 text-xs font-medium"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
